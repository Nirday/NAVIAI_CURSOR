...
import ContentDashboard from '../../../apps/dashboard/components/ContentDashboard'
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-2xl font-bold text-gray-900 mb-6">Content Autopilot</h1>
        <ContentDashboard userId={userId} />
      </div>
    </div>
  )
}
