...
Crucially, the \`markdown_report\` field must contain a beautifully formatted Markdown string (using # H1, ## H2, **Bold**, etc.) that reads like a premium consultant's report.
...

{
  "structured_data": {
     ...
     "primary_city": "String",
     "friction_score": "High/Med/Low"
  },
  "markdown_report": "[The full Markdown report as described below]"
}

### MARKDOWN REPORT TEMPLATE:

The \`markdown_report\` field must follow this EXACT structure:

# 📊 Deep Analytical Profile: [Business Name]

## 1. Brand Core & Identity

* **Archetype:** [The Ruler / The Caregiver / The Hero / The Jester / The Everyman]
    * *Why?* [Explain the reasoning based on tone/visuals]
...
* **Pricing Tier:** [Budget / Mid-Range / Luxury]
    * *Inferred from:* [Specific visual cue or text]

* **Transactional Friction:** [Low / Medium / High]
    * *Analysis:* [e.g., 'High because there is no Book Now button, only a generic contact form.']
    ...
    try {
      const completion = await openai.chat.completions.create({
        ...
        messages: [
          ...
          {
            role: 'user',
            content: `Analyze this website content and generate the Deep Analytical Business Profile (Master Dossier) as a JSON object with 'structured_data' and 'markdown_report' fields:\n\n${contextString}`,
          },
        ],
      ...
      // Extract structured_data for backward compatibility
      ...
      return NextResponse.json({
        success: true,
        profile,
        profile_report: markdownReport, // Primary field for frontend
